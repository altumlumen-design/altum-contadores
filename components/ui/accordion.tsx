...
function AccordionContent({
  ...
  return (
    ...
    >
      <div
        className={cn(
          'pt-0 pb-2.5 h-(--accordion-panel-height) transition-[height] duration-300 ease-out data-ending-style:h-0 data-starting-style:h-0 [&_a]:underline [&_a]:underline-offset-3 [&_a]:hover:text-foreground [&_p:not(:last-child)]:mb-4',
          className,
        )}
      >
        {children}
